...
DEFAULT_FILL_COLOR = QColor(207, 63, 199, 60)
    ...
    def paint(self, painter):
        if self.points:
            ...
            if self.fill:
                ...
                # TODO: where is self.fill_color?
                # color = self.select_fill_color if self.selected else self.fill_color
                ddt_fill_color = DEFAULT_FILL_COLOR
                color = self.select_fill_color if self.selected else ddt_fill_color
                # print(
                #     "fill",
                #     color.getRgb(),
