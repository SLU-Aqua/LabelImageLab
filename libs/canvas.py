...
class Canvas(QWidget):
    ...
    def mouseMoveEvent(self, ev: QMouseEvent):
        ...
        # print("mouseMoveEvent", ev.button())
        # print("  button:", ev.button())
        # print("  buttons:", ev.buttons())
        ...
        if Qt.RightButton & ev.buttons():
            # print("mouseMoveEvent: Qt.RightButton & ev.buttons()")
        ...
        if Qt.LeftButton & ev.buttons():
            # print("Qt.LeftButton & ev.buttons():")
            if self.selected_vertex():
                ...
                # print("self.selected_shape and self.prev_point:")
                self.override_cursor(CURSOR_MOVE)
            ...
            else:  # TODO: do nonting? Nothing to pan?
                # print("pan: TODO: do nonting? Nothing to pan?")
                # pan
        ...
        # print("len(priority_list):", len(priority_list))
    ...
    def mousePressEvent(self, ev):
        ...
        if ev.button() == Qt.LeftButton:
            if self.drawing():
                # print("mousePressEvent: LeftButton: drawing")
                self.handle_drawing(pos)
            else:
                # print("mousePressEvent: LeftButton: else")
                selection = self.select_shape_point(pos)
                self.prev_point = pos

                # if self.selected_vertex():
                # print("mousePressEvent: LeftButton: else. selected_vertex()")

                if selection is None:
                    # print("mousePressEvent: LeftButton: else: pan")
                    # pan
                    QApplication.setOverrideCursor(QCursor(Qt.OpenHandCursor))
                    self.pan_initial_pos = ev.pos()

        elif ev.button() == Qt.RightButton and self.editing():
            # print("mousePressEvent: ev.button() == Qt.RightButton and self.editing()")
    ...
    def mouseReleaseEvent(self, ev):
        if ev.button() == Qt.RightButton:
            # print(bool(self.selected_shape_copy))
    ...
    def paintEvent(self, event):
        ...
        if self.overlay_color:
            ...
            # painter.fillRect(temp.rect(), QColor(255, 255, 0, 200))
            painter.end()
