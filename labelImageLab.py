...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(
        ...
        self.label_file_format = settings.get(
            SETTING_LABEL_FILE_FORMAT, LabelFileFormat.BSP
        )
        ...
        if self.label_hist:
            ...
            print("No default class file is defined (optional)")
        ...
        self.use_default_label_checkbox = QCheckBox(
            self.string_bundle.get_str("useDefaultLabel")
        )
        ...
        # self.diffc_button = QCheckBox(self.string_bundle.get_str("useDifficult"))
        ...
        self.dock = QDockWidget(self.string_bundle.get_str("boxLabelText"), self)
        ...
        self.file_dock = QDockWidget(self.string_bundle.get_str("fileList"), self)
        self.file_dock.setObjectName(self.string_bundle.get_str("files"))
        self.file_dock.setWidget(file_list_container)

        self.zoom_widget = ZoomWidget()
        self.light_widget = LightWidget(self.string_bundle.get_str("lightWidgetTitle"))
        ...
        quit = action(
            self.string_bundle.get_str("quit"),
            self.close,
            "Ctrl+Q",
            "quit",
        ...
        change_save_dir = action(
            self.string_bundle.get_str("changeSaveDir"),
        ...
        open_next_image = action(
            self.string_bundle.get_str("nextImg"),
            self.open_next_image,
            "d",
            "next",
            self.string_bundle.get_str("nextImgDetail"),
        )

        open_prev_image = action(
            self.string_bundle.get_str("prevImg"),
            self.open_prev_image,
            "a",
            "prev",
            self.string_bundle.get_str("prevImgDetail"),
        )

        verify = action(
            self.string_bundle.get_str("verifyImg"),
            self.verify_image,
            "space",
            "verify",
        ...
        save = action(
            self.string_bundle.get_str("save"),
            self.save_file,
            "Ctrl+S",
            "save",
            self.string_bundle.get_str("saveDetail"),
            enabled=False,
        )
        ...
        #     self.string_bundle.get_str("changeSaveFormat"),
        #     enabled=True,
        # )
        ...
        close = action(
            ...
            "Ctrl+W",
            "close",
            self.string_bundle.get_str("closeCurDetail"),
        )

        delete_image = action(
            self.string_bundle.get_str("deleteImg"),
            self.delete_image,
            "Ctrl+Shift+D",
            "close",
            self.string_bundle.get_str("deleteImgDetail"),
        )

        reset_all = action(
            self.string_bundle.get_str("resetAll"),
            self.reset_all,
            None,
            "resetall",
            self.string_bundle.get_str("resetAllDetail"),
        )

        color1 = action(
            self.string_bundle.get_str("boxLineColor"),
            self.choose_color1,
            "Ctrl+L",
            "color_line",
            self.string_bundle.get_str("boxLineColorDetail"),
        )

        create_mode = action(
            self.string_bundle.get_str("crtBox"),
            self.set_create_mode,
            "w",
            "new",
            self.string_bundle.get_str("crtBoxDetail"),
            enabled=False,
        )
        edit_mode = action(
            self.string_bundle.get_str("editBox"),
            self.set_edit_mode,
            "Ctrl+J",
            "edit",
            self.string_bundle.get_str("editBoxDetail"),
            enabled=False,
        )
        ...
        # copy = action(
        #     self.string_bundle.get_str("dupBox"),
        #     self.copy_selected_shape,
        #     "Ctrl+D",
        #     "copy",
        #     self.string_bundle.get_str("dupBoxDetail"),
        #     enabled=False,
        # )
        ...
        hide_all = action(
            ...
            "Ctrl+H",
            "hide",
            self.string_bundle.get_str("hideAllBoxDetail"),
            enabled=False,
        )
        show_all = action(
            self.string_bundle.get_str("showAllBox"),
            partial(self.toggle_polygons, True),
            "Ctrl+A",
            "hide",
            self.string_bundle.get_str("showAllBoxDetail"),
            enabled=False,
        )

        # help_default = action(
        #     self.string_bundle.get_str("tutorialDefault"),
        #     self.show_default_tutorial_dialog,
        #     None,
        #     "help",
        #     self.string_bundle.get_str("tutorialDetail"),
        # )
        show_info = action(
            self.string_bundle.get_str("info"),
        ...
        #     self.string_bundle.get_str("shortcut"),
        ...
        zoom_in = action(
            self.string_bundle.get_str("zoomin"),
            partial(self.add_zoom, 10),
            "Ctrl++",
            "zoom-in",
            self.string_bundle.get_str("zoominDetail"),
            enabled=False,
        )
        zoom_out = action(
            self.string_bundle.get_str("zoomout"),
            partial(self.add_zoom, -10),
            "Ctrl+-",
            "zoom-out",
            self.string_bundle.get_str("zoomoutDetail"),
            enabled=False,
        )
        zoom_org = action(
            self.string_bundle.get_str("originalsize"),
            partial(self.set_zoom, 100),
            "Ctrl+=",
            "zoom",
            self.string_bundle.get_str("originalsizeDetail"),
            enabled=False,
        )
        fit_window = action(
            self.string_bundle.get_str("fitWin"),
            self.set_fit_window,
            "Ctrl+F",
            "fit-window",
            self.string_bundle.get_str("fitWinDetail"),
            checkable=True,
            enabled=False,
        )
        fit_width = action(
            self.string_bundle.get_str("fitWidth"),
            self.set_fit_width,
            "Ctrl+Shift+F",
            "fit-width",
            self.string_bundle.get_str("fitWidthDetail"),
            checkable=True,
            enabled=False,
        )
        ...
        light_brighten = action(
            self.string_bundle.get_str("lightbrighten"),
            partial(self.add_light, 10),
            "Ctrl+Shift++",
            "light_lighten",
            self.string_bundle.get_str("lightbrightenDetail"),
            enabled=False,
        )
        light_darken = action(
            self.string_bundle.get_str("lightdarken"),
            partial(self.add_light, -10),
            "Ctrl+Shift+-",
            "light_darken",
            self.string_bundle.get_str("lightdarkenDetail"),
            enabled=False,
        )
        light_org = action(
            self.string_bundle.get_str("lightreset"),
            partial(self.set_light, 50),
            "Ctrl+Shift+=",
            "light_reset",
            self.string_bundle.get_str("lightresetDetail"),
            checkable=True,
            enabled=False,
        )
        ...
        edit = action(
            self.string_bundle.get_str("editLabel"),
            self.edit_label,
            "Ctrl+E",
            "edit",
            self.string_bundle.get_str("editLabelDetail"),
            enabled=False,
        )
        self.edit_button.setDefaultAction(edit)

        shape_line_color = action(
            self.string_bundle.get_str("shapeLineColor"),
            self.choose_shape_line_color,
            icon="color_line",
            tip=self.string_bundle.get_str("shapeLineColorDetail"),
            enabled=False,
        )
        shape_fill_color = action(
            self.string_bundle.get_str("shapeFillColor"),
            self.choose_shape_fill_color,
            icon="color",
            tip=self.string_bundle.get_str("shapeFillColorDetail"),
            enabled=False,
        )

        labels = self.dock.toggleViewAction()
        labels.setText(self.string_bundle.get_str("showHide"))
        ...
        self.menus = Struct(
            file=self.menu(self.string_bundle.get_str("menu_file")),
            edit=self.menu(self.string_bundle.get_str("menu_edit")),
            view=self.menu(self.string_bundle.get_str("menu_view")),
            help=self.menu(self.string_bundle.get_str("menu_help")),
            recentFiles=QMenu(self.string_bundle.get_str("menu_openRecent")),
            labelList=label_menu,
        )

        # Auto saving : Enable auto saving if pressing next
        self.auto_saving = QAction(self.string_bundle.get_str("autoSaveMode"), self)
        self.auto_saving.setCheckable(True)
        self.auto_saving.setChecked(settings.get(SETTING_AUTO_SAVE, False))
        # Sync single class mode from PR#106
        self.single_class_mode = QAction(
            self.string_bundle.get_str("singleClsMode"), self
        )
        ...
        self.display_label_option = QAction(
            self.string_bundle.get_str("displayLabel"), self
        )
        ...
        add_actions(self.menus.help, (show_info,))
    ...
    def reset_state(self):
        ...
        #    print(i, self.label_list.item(i))
    ...
    def load_file(self, file_path=None):
        ...
        # print("self.file_list_widget.count():", self.file_list_widget.count())
        ...
        # print("unicode_file_path:", unicode_file_path, type(unicode_file_path))
...
def get_main_app(argv=None):
    ...
    argparser.add_argument(
        ...
        type=str,
        # metavar="J",
        help="Path to images and annoations.",
    )
    argparser.add_argument(
        "-c",
        "--class_file",
        default=os.path.join(os.path.dirname(__file__), "data", "bsp_ring_classes.txt"),
        type=str,
        # metavar="J",
        help="Path to class file definition.",
    )
    argparser.add_argument(
        "-s",
        "--save_dir",
